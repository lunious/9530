...
public class SearchView extends LinearLayout {
    ...
    private AppCompatTextView atvSearch;//搜索
    ...
    private DCallBack dCallBack;//删除内容回调接口
    private SCallBack sCallBack;//删开始搜索回调接口
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        int defaultColor = context.getResources().getColor(R.color.view); // 默认颜色 = 灰色
        ...
        // 搜索框颜色
        int defaultColor2 = context.getResources().getColor(R.color.main_theme_color); // 默认颜色 = 白色
    ...
    private void init() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!(mCallBack == null)) {
                    mCallBack.SearchAciton(textView.getText().toString());
                }
                tv_clear.setVisibility(GONE);
                listView.setVisibility(GONE);
        ...
        atvSearch.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {

                if (!TextUtils.isEmpty(et_search.getText().toString().trim())) {
                    if (!(sCallBack == null)) {
                        sCallBack.StartSearch(et_search.getText().toString().trim());
                        tv_clear.setVisibility(GONE);
                        listView.setVisibility(GONE);
                    }
                } else {
    ...
    private void queryData(String tempName) {
        ...
        adapter = new SimpleCursorAdapter(context, R.layout.search_list_item, cursor, new String[]{"name"},
     ...
     * 搜索
     */
    public void setOnClickStartSearch(SCallBack sCallBack) {
     ...
     * 内容变化
     */
    public void setOnClickDele(DCallBack dCallBack) {
