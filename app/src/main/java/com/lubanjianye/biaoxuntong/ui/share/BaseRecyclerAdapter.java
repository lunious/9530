    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            ...
            case VIEW_TYPE_FOOTER:
                return new FooterViewHolder(mInflater.inflate(R.layout.quick_view_load_more, parent, false));
            default:
            ...
            case VIEW_TYPE_FOOTER:
                ...
                switch (mState) {
                    ...
                    case STATE_LOAD_MORE:
                        fvh.tv_footer.setText(mContext.getResources().getString(R.string.state_loading_more));
