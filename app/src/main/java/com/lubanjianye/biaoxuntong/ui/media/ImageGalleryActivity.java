...
import com.lubanjianye.biaoxuntong.ui.share.AppOperator;

import com.lubanjianye.biaoxuntong.util.BitmapUtil;
import com.lubanjianye.biaoxuntong.util.Loading;
import com.lubanjianye.biaoxuntong.util.stream.StreamUtil;
...
public class ImageGalleryActivity extends ImageBaseActivity implements ViewPager.OnPageChangeListener,
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (success) {
                    ...
                    Toast.makeText(ImageGalleryActivity.this, "存储失败", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
